...
def main():
    ...
    # Construct the input file path based on the script's directory
    input_file_name = "p_assignment_trees.txt"
    input_path = script_directory / input_file_name
    ...
    try:
        ...
        with open(input_path, 'r') as file:
            ...
            if abbreviations:
                # Use script_directory for creating the output_path
                output_path = script_directory / f"{Path(input_file_name).stem}_abbrevs.txt"
        ...
        print(f"File '{input_file_name}' not found in the script's directory. Please make sure the file exists.")
